...
from xml.etree.cElementTree import ElementTree, parse, ParseError
...
class DocumentParser(InputParser):
    ...
    def load_corpus(self) -> List[ElementTree]:
        ...
        :return: The corpus, which is the input to the fuzzer (str).
        """
        corpus: List[ElementTree] = []
        ...
        # loop through the files and parse into elementtree and append those to corpus
        for file in files:
